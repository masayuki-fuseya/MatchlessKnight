...
// モデルデータ読み込み
unique_ptr<LandShapeData> LandShapeData::CreateFromData(const char* meshData)
{
	// 最新の読み込み位置を示すポインタ
...
// モデルデータ読み込み
unique_ptr<LandShapeData> LandShapeData::CreateFromFile(const wchar_t* szFileName)
{
	ifstream ifs;
